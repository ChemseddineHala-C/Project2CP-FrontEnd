...
class NotificationConsPage extends StatefulWidget {
  const NotificationConsPage({super.key});

  @override
  State<NotificationConsPage> createState() => _NotificationConsPageState();
}

class _NotificationConsPageState extends State<NotificationConsPage> {
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          "Mark all as read",
                          style: TextStyle(color: Color(0xFFD5A439)),
                        ),
                      ),
                    ),
  ...
  Widget _buildNotifCard(Map<String, dynamic> notif, bool isDark) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          left: BorderSide(
            color: isRead ? Colors.transparent : Color(0xFFD5A439),
            width: 4,
          ),
        ),
        boxShadow: [
            ...
            children: [
              ...
              if (!isRead)
                const Padding(
                  ...
                  child: CircleAvatar(radius: 4, backgroundColor: Color(0xFFD5A439)),
                ),
            ],
          ),
        ],
